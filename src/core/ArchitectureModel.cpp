...
Result ArchitectureModel::addNodeToLayer(NodeId n,LayerId l){return db_.addNodeToLayer(n,l);}
Result ArchitectureModel::removeNodeFromLayer(NodeId n,LayerId l){return db_.removeNodeFromLayer(n,l);}
std::vector<NodeLayer> ArchitectureModel::nodesInLayer(LayerId l)const{return db_.getNodesInLayer(l);}
